...
`[User Ticket] -> [AgentController (Budget, State, Retries)] <-> [Groq Client: gpt-oss-20b]                          |                  [ToolRegistry: Schema Validation, LoopGuard, RiskPolicy, Concurrency]                          |                  [SimulationEnvironment: Authoritative Topology, Perturbations, Recovery]`
